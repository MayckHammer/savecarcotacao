...
const Inspection = () => {
  ...
  if (loading) {
    return (
      <div className="flex min-h-screen flex-col bg-savecar-gradient items-center justify-center">
    ...
    <div className="flex min-h-screen flex-col bg-savecar-gradient pb-20">
      ...
      <div className="flex-1 px-4 py-6 space-y-6">
        ...
        <LiquidGlass
          ...
          overLight={true}
        >
          <div className="flex items-center gap-3 rounded-xl border border-border bg-card/80 p-4">
